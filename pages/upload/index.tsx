...
const Upload = () => {
  ...
  return (
    <div className="flex w-full h-full absolute left-0 top-[60px] mb-10 pt-10 lg:pt-20 bg-[#F8F8F8] justify-center">
      <div className="bg-white rounded-lg w-[60%] justify-between xl:h-[80vh] flex gap-6 flex-wrap items-center p-14 pt-6">
        <div>
          <div>
          ...
          <div className="flex flex-col gap-3 pb-10">
            ...
            <div className="flex gap-6 mt-10">
              <button
                ...
                className="border-gray-300 border-2 font-medium p-2 rounded w-28 lg:w-44 outline-none"
              >
                Discard
              </button>
              <button
                onClick={handlePost}
                className="bg-[#F51997] text-white border-2 font-medium p-2 rounded w-28 lg:w-44 outline-none"
              >
                Post
              </button>
            </div>
